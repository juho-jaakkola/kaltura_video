...
<?php
	...
	//get the group files
	//comment this if you want to show the classic little object listing
...
if ($result) {
	...
	foreach($result as $ob) {
		if ($metadata = kaltura_get_metadata($ob)) {
			...
			if (trim($ob->description)) {
				$body .= '<p><a href="#" onclick="$(this).parent().next().slideToggle(\'fast\');return false;">' . elgg_echo('kalturavideo:more') . '</a></p>';
			}
