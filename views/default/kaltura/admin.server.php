...
<p>
	...
	<?php
		echo elgg_view('input/dropdown', array(
			...
			'value' => (elgg_get_plugin_setting('kaltura_server_type') ? elgg_get_plugin_setting('kaltura_server_type') : 'corp')
			)
		);
	?>
</p>
<div id="kaltura_video_layer_server_corp"<?php echo (elgg_get_plugin_setting('kaltura_server_type')=='ce' ? 'style="display:none;"' : ''); ?>>
<p>
...
<div id="kaltura_video_layer_server_ce"<?php echo (elgg_get_plugin_setting('kaltura_server_type')=='ce' ? '' : 'style="display:none;"'); ?>>
<p>
	<?php echo elgg_echo('kalturavideo:server:ceurl'); ?>: <br />
	<?php
		echo elgg_view('input/text', array('name' => 'kaltura_server_url','id' => 'kaltura_server_url','disabled'=>$configured, 'value' => (elgg_get_plugin_setting('kaltura_server_url') ? elgg_get_plugin_setting('kaltura_server_url') : $CONFIG->wwwroot.'kalturaCE/') ));
	?>
</p>
