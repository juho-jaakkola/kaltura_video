...
if ($page_owner == $_SESSION['user']) {
	...
	$params['title'] = elgg_echo(sprintf(elgg_echo('kalturavideo:user:friends'),$page_owner->name));
}

// Get a list of blog posts
$params['content'] .= list_user_friends_objects($page_owner->getGUID(), 'kaltura_video', 10, false);
