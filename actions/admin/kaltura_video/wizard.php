...
if ($type == 'partner_wizard') {
	...
	if ($agreeToTerms && empty($error)) {
		...
		try {
			...
			//Register Elgg vars
			//server part
			elgg_set_plugin_setting("kaltura_server_type",'corp',"kaltura_video"); //automatic registering is only for kaltura.com
			elgg_set_plugin_setting("kaltura_server_url",'',"kaltura_video"); //default in definitions.php
			//partner part
			...
			elgg_set_plugin_setting("password",$cmsPassword,"kaltura_video");
